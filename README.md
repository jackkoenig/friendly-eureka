...
Please refresh the repository page in your browser until you see a 2nd commit by `actions-user` titled `Template cleanup`.
...
```sh
git clone git@github.com:jackkoenig/friendly-eureka.git
cd friendly-eureka
```
...
#### Commit your changes
```sh
git commit -m 'Starting friendly-eureka'
